...
== Nouveautés de la version 23.01.1
...
IMPORTANT: Kubernetes 1.26 est désormais pris en charge par Trident. Veuillez mettre à niveau Astra Trident avant de mettre à niveau Kubernetes.
